        ...
        <div className='max-w-full min-h-screen grid grid-cols-1 md:grid-cols-2 justify-items-center  px-7 md:p-28 lg:p-28 p-28 gap-6' id='home'>
            <div className='flex flex-col items-start justify-center w-full sm:p-7' data-aos="zoom-in">
                ...
                <div className='flex sm:items-center md:items-start items-start space-x-6 mt-6 lg:flex-row md:flex-col '>
                    ...
                    <Link href="/Resume/GowthamNagaraj.docx" download><Button className="bg-[#072a56] text-[#ffffff] hover:bg-[#465f7c] cursor-pointer text-xs" data-aos="fade-down">Download my resume <FaFileDownload /></Button></Link>
